...
app = Flask(__name__)
##postgress
engine = create_engine("mysql+pymysql://root:345678@localhost:3306/asad")
...
def view():
    if request.method == "POST":
        ...
        db.execute("INSERT into fee(firstname, lastname, session, subfee, duefee, totalfee) VALUES (:firstname, :lastname, :session, :subfee, :duefee, :totalfee)",
                {"firstname": fname, "lastname": lname, "session": session, "subfee": sub_fee, "duefee": due_fee, "totalfee": tot_fee})
        db.commit()
